# Binary Expected-Value Tool (B.E.T.)
...
- **Sportsbook Comparison**: Visualize profitability by sportsbook and betting strategy
- **Bankroll Management**: Track deposits, withdrawals, and balance across multiple platforms
...
- **Promotion Harvesting**: Extracting value from sportsbook promotions
- **+EV Betting**: Identifying and exploiting positive expected value opportunities
...
- LinkedIn: [linkedin.com/in/p-huynh](https://linkedin.com/in/p-huynh)
- GitHub: [github.com/PeterHuynh60](https://github.com/PeterHuynh60)
